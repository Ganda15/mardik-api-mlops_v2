> **Énoncé d'origine du dépôt** (fourni avec le brief), conservé tel quel. L'état actuel du projet est décrit
> dans le [README](../README.md) : les modules marqués ici `[STUB]` ont tous été construits.
