...
| **21** ✅ | gate réel manuel `gate-reel.yml`, tag `eval-ok/<sha>`, publication qui l'exige sur variable — **exécuté sur Azure le 23/09**, un passage refusé (P95 12,5 s) | `tests/test_gate_reel.py` |
